...
2.  Draw a linegraph of some piece-wise constant signal $\mu$ with more than one change-in-mean, where with a reasonable penalty/signal-to-noise ration Binary Segmentation would consistently miss the changes, but Optimal Partitioning wouldn't.
