...
2.  In this exercise we will show that: $$ \frac{1}{\sigma}\sqrt{\frac{\tau(n-\tau)}{n}} ( \bar{y}_{1:\tau} - \bar{y}_{(\tau+1):n}) $$ in case of no change, e.g. for $\mu_1 = \mu_2 = \dots = \mu_n = \mu$, follows a standard normal distribution. **Hint:**
