...
This is possible to prove directly after some tedious algebraic
manipulations.
...
\[
\sum_{i=1}^{n} (y_i - \bar{y}_{1:n})^2 = \sum_{i=1}^{n} y_i^2 + 2 n \bar{y}_{1:\tau}^2 - \bar{y}_{1:\tau} \sum_{i=1}^{\tau} y_i
\] As \(\sum_{i=1}^{n} y_i = n \bar{y}_{1:n}\), we notice that we can
simplify this equation, by combining two terms. We are left with:

\[
\sum_{i=1}^{n} (y_i - \bar{y}_{1:n})^2 = \sum_{i=1}^{n} y_i^2 + n \bar{y}_{1:\tau}^2
\]

We procede similarly for the other two terms:
...
\textbf{?@eq-lr-test}. In fact, rearranging equation above, gives us:
