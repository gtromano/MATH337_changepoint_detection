...
This is possible to prove directly after some tedious algebraic manipulations.
...
$$ As $\sum_{i=1}^{n} y_i = n \bar{y}_{1:n}$, we notice that we can simplify this equation, by combining two terms. We are left with:
