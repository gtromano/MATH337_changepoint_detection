...
At the end of each chapter, you will find exercises that will be carried in the workshop and the lab. 
During the workshop, you will be dealing with computations and details about the methodologies introduced at your own pace, and, finally, during the workshops, you'll give a go at programming the various algorithms and running real-world examples.
...
The notes are released as open-source on GitHub under the [CC BY-NC 4.0 License](https://github.com/gtromano/MATH337_changepoint_detection?tab=License-1-ov-file). You can access the repository at the following link: [https://github.com/gtromano/MATH337_changepoint_detection](https://github.com/gtromano/MATH337_changepoint_detection).
