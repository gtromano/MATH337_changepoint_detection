...
$$
\mathcal{L}(y_{s+1:t}) = (t - s + 1) \log(2\pi \sigma^2) + \frac{1}{\sigma^2} \sum_{i = s}^{t} \left ( y_i - \bar{y}_{s+1:t} \right)^2.
$$
...
\mathcal{L}(y_{s+1:t}) = \frac{1}{\sigma^2} \sum_{i = s}^{t} \left ( y_i - \bar{y}_{s+1:t} \right)^2.
$$
