...
where $\theta_2$ is the new slope after the changepoint. In other words, the model is showing a piecewise linear mean.
...
out <- cpt.reg(data, method="AMOC", minseglen=5, penalty="MBIC", test.stat="Normal")
